...
export const service: Serverless = {
  ...
  "provider": {
    ...
    "deploymentBucket": {
      name: "vm-slsdeploymentbucket-${self:provider.region}"
    },
    "iam": {
      "role": {
        ...
        "statements": [
          {
            "Effect": "Allow",
            "Resource": [
              "arn:aws:lambda:::${self:custom.appName}*",
              "arn:aws:apigateway:::${self:custom.appName}*"
            ],
            "Action": [
              "sqs:*",
              "dynamodb:*",
  ...
  "custom": {
    ...
    "aggregationStartSQS": "AggregationStart",
    "defaultStage": "dev",
    "syncRateMinutes": 10,
    "webpack": {
      "packager": "yarn",
